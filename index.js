...
copy(flavorCopy, originalFlavors);
...
function addFlavor(orginal, newFlavor) {
  orginal.unshift(newFlavor);
  return orginal;
}
...
function getRandomFlavors(array1, array2, array3, array4) {
  let array5 = array1.concat(array2, array3, array4);
